...
while($row = mysqli_fetch_assoc($res)){
    ...
    if($name == $_SESSION['username']){
        echo '<div class="chat_div" style="display:flex;margin-top:10px; background:transparent; width:60%;float:left;padding:5px;margin:10px;border-radius:5px;">
        ...
        echo '<div class="chat_div" style="display:flex;margin-top:10px; background:transparent; width:60%;float:right;padding:5px;margin:10px;border-radius:5px;">
